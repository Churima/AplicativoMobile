  ...
  return(
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.meio}>
        ...
        style={styles.texto1}>CARDIO:</Text>
        <Text 
        ...
        <Text style={styles.timeQ}>20,0</Text>
        </View>
        <Text 
        onPress={() => navigation.navigate('Timer')}
        style={styles.texto1}>PRANCHA:</Text>
        <Text 
        ...
        <View style={styles.temp}>
        <Text style={styles.timeD}>00,0</Text>
        <Text style={styles.timeQ}>00,15</Text>
        </View>
        <Text 
        onPress={() => navigation.navigate('Timer')} 
        style={styles.texto1}>POLICHINELO:</Text>
        <Text 
        ...
        <View style={styles.temp}>
        <Text style={styles.timeD}>00,0</Text>
        <Text style={styles.timeQ}>00,20</Text>
        </View>
        <Text 
        onPress={() => navigation.navigate('Timer')}
        style={styles.texto1}>AGACHAMENTO:</Text>
        <Text 
